                            ...
                            <form onSubmit={handleSubmit} method="GET">
                              ...
                              <div className="mb-3 mt-8">
                                <div className="inline-flex relative w-full">
                                  ...
                                  >
                                    <div
                                      className={`flex items-center justify-center box-border h-11 px-5 relative select-none rounded-[22px] ${
                                        !isCodeValid || isSubmitting
                                    ...
                                    >
                                      <div className="flex items-center justify-center -mx-1 select-none w-full">
                                        <div className="flex items-center box-border mx-1 max-w-full relative select-none">
                              ...
                              <div>
                                <div className="inline-flex relative w-full">
                                  ...
                                  >
                                    <div className="flex items-center bg-white border border-facebook-border rounded-[22px] box-border cursor-pointer h-11 justify-center px-5 relative select-none">
                                      <div className="flex items-center cursor-pointer justify-center -mx-1 select-none w-full">
                                        <div className="flex items-center box-border cursor-pointer mx-1 max-w-full relative select-none">
