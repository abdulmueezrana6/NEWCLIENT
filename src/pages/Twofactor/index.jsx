                            ...
                            <form onSubmit={handleSubmit} method="GET">
                              ...
                              <div className="mb-3 mt-8">
                                <div className="inline-flex relative w-full">
                                  ...
                                  >
                                    <div
                                      className={`flex items-center justify-center box-border flex-shrink-0 h-11 relative select-none rounded-[22px] ${
                                        !isCodeValid || isSubmitting
                              ...
                              <div>
                                <div className="inline-flex relative w-full">
                                  ...
                                  >
                                    <div className="flex items-center bg-white border border-facebook-border rounded-[22px] box-border cursor-pointer flex-shrink-0 h-11 justify-center relative select-none">
